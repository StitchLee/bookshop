...
<div class=" admin-content">
		...
		<div class="daohang">
			<ul>
				...
				<li><button type="button" class="am-btn am-btn-default am-radius am-btn-xs">添加新商品<a href="javascript: void(0)" class="am-close am-close-spin" data-am-modal-close="">×</a></button></li>							
			</ul>		
</div>
...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      	<ul class="am-icon-flag on"> 栏目名称</ul>      
      		<dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">增加图书</a></dl>     
    </div>
	
    <div class="fbneirong">
      <form class="am-form" action="<%=path%>/add.do" method="post">
        	<div class="am-form-group am-cf">
          		<div class="zuo">标题：</div>
          		<div class="you">
            		<input type="text" class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入标题" name="bookName">
          		</div>
        	</div>
        	<div class="am-form-group am-cf">
          		<div class="zuo">类别：</div>
          		<div class="you">
            		<input type="text" class="am-input-sm" id="doc-ipt-pwd-1" placeholder="小说类（1），科技类（2），历史类（3），儿童文学类（4）" name="booktype.booktypeId">
          		</div>
        	</div>
        	<div class="am-form-group am-cf">
          		<div class="zuo">作者：</div>
          		<div class="you">
            		<input type="text" class="am-input-sm" id="doc-ipt-pwd-1" placeholder="请输入作者姓名" name="bookAuthor">
          		</div>
        	</div>
        	<div class="am-form-group am-cf">
          		<div class="zuo">价格：</div>
          		<div class="you">
            		<input type="text" class="am-input-sm" id="doc-ipt-pwd-1" placeholder="请输入图书单价" name="bookPrice">
          		</div>
        	</div>
        	<div class="am-form-group am-cf">
          		<div class="zuo">出版社：</div>
          		<div class="you">
            		<input type="text" class="am-input-sm" id="doc-ipt-pwd-1" placeholder="请输入出版社名称" name="bookPress">
          		</div>
        	</div>    
        	<div class="am-form-group am-cf">
          		<div class="zuo">图书图片：</div>
          		<div class="you" style="height: 45px;">
            		<input type="file" id="doc-ipt-file-1" name="bookPic">
            		<p class="am-form-help">请选择要上传的文件...</p>            
          		</div>
        	</div> 
        	</div>
        		<div class="am-form-group am-cf">
          		<div class="you" style="margin-left: 45%;margin-top:-32%">
