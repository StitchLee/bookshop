...
<div class=" admin-content">
		...
		<div class="daohang">
			<ul>
				...
				<li><button type="button" class="am-btn am-btn-default am-radius am-btn-xs">增加商品类别<a href="javascript: void(0)" class="am-close am-close-spin" data-am-modal-close="">×</a></button></li>
...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">增加商品类别</a></dl>
    ...
    <div class="fbneirong">
      <form class="am-form" action="<%=path%>/addtype.do" method="post">
        <div class="am-form-group am-cf">
          <div class="zuo">类别：</div>
          <div class="you">
            <input type="text" class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入标题" name="booktypeName">
          </div>
