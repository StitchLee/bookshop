...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">更新图书</a></dl>
    ...
    <div class="fbneirong">
      <form:form modelAttribute="book" class="am-form" action="update.do" method="post">
      	<form:hidden path="bookId"/>
        <div class="am-form-group am-cf">
          <div class="zuo">标题：</div>
          <div class="you">
            <form:input  class="am-input-sm"  path="bookName"/>
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">类别：</div>
          <div class="you">
            <form:input type="text" class="am-input-sm" id="doc-ipt-pwd-1" placeholder="小说类（1），科技类（2）" path="booktype.booktypeId"/>
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">作者：</div>
          <div class="you">
            <form:input type="text" class="am-input-sm" id="doc-ipt-pwd-1" placeholder="请输入作者姓名" path="bookAuthor"/>
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">价格：</div>
          <div class="you">
            <form:input type="text" class="am-input-sm" id="doc-ipt-pwd-1" placeholder="请输入图书单价" path="bookPrice"/>
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">出版社：</div>
          <div class="you">
            <form:input type="text" class="am-input-sm" id="doc-ipt-pwd-1" placeholder="请输入出版社名称" path="bookPress"/>
          </div>
        </div>    
        <div class="am-form-group am-cf">
          <div class="zuo">图书图片：</div>
          <div class="you" style="height: 45px;">
            <form:input type="file" id="doc-ipt-file-1" path="bookPic"/>
