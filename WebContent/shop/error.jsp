...
<div id="templatemo_container">
    ...
    <div id="templatemo_header">
    	<form action="<%=path%>/register.jsp" method="post">
    	<div id="templatemo_special_offers">
        	<p style = "color:red; font-size:18px; margin-top:10px">注册失败，请重新注册</p>			
        </div>       
        <div id="templatemo_new_books">
        	<p style="margin-left: 20px;margin-top:-25px">
				<input type="submit" value="注册"style="width:100px; height:50px; margin-left:10px;margin-top:30px"/><br/>
        	</p>
        </div>
        </form>
    </div> <!-- end of header -->
