...
<div id="templatemo_container">
	<div id="templatemo_menu">
    	<ul>
             <li><a href="<%=path%>/goToMain.do?name=${customer.customerName}" class="current">主页</a></li>
            <li><a href="<%=path%>/bookpage.do?name=${customer.customerName}&id=${newbook.bookId}">商品分类</a></li>
...
<a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/images/vcss-blue" alt="Valid CSS!" vspace="8" border="0" /></a>
      ...
      <div class="fbneirong" style="color: black">
      			<div class="am-form-group am-cf">
         			 <div class="zuo"style="width:200px;margin-left:40px" >ID：  ${customer.customerId}</div>
       			</div>
        		<div class="am-form-group am-cf">
         			 <div class="zuo"style="width:200px;margin-left:56px">用户名：  ${customer.customerName}</div>
       			</div>
        		<div class="am-form-group am-cf">
          			<div class="zuo" style="width:400px;margin-left:-110px">密码：  ${customer.customerPwd}</div>			 
        		</div>
        		<div class="am-form-group am-cf">
          			<div class="zuo" style="width:200px;margin-left:124px">联系电话：${customer.customerTel}</div>
        		</div>
        		<div class="am-form-group am-cf">
         			 <div class="zuo" style="width:400px;margin-left:-26px">邮箱地址：${customer.customerEmail}</div>
        		</div>
        		<div class="am-form-group am-cf">
          			<div class="zuo" style="width:200px;margin-left:80px">收货地址：${customer.customerAddr}</div>
        		</div>  
        		<div class="am-form-group am-cf">
          			<div class="zuo"style="width:600px;margin-left:-207px">注册时间：${customer.customerTime}</div>
        		</div>
        		<form action="updateNeed.do?id= ${customer.customerId}" method="post">
        		<div class="am-form-group am-cf">
