    ...
    <div id="templatemo_content">
        ...
        <div id="templatemo_content_right" >       	
            <h1><span style="margin-left:280px">详情</span></h1>   
      		<div class="fbneirong" style="color:white;font-size:30px;margin-left:175px;margin-top:200px;margin-bottom:450px">
      			<p>支付成功，请返回<a href="<%=path%>/goToMain.do?name=${name}&id=${newbook.bookId}">主页</a></p>
